...
Context files for running a high-velocity startup with AI-powered operations. Built by Roxy for the [The Village](https://thevillageapp.com) during our pre-seed sprint.
